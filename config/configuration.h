...
#define STRING_VERSION_CONFIG_H __DATE__ "15/08/14 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(ELECTROTUTO, default config)" // Who made the changes.
...
#define PROBE_SERVO_DEACTIVATION_DELAY 120
...
#define HOMING_FEEDRATE {50*60, 50*30, 60*3, 0}  // set the homing speeds (mm/min)

// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT {55.7402,52.7402,200.0*60/3,760*0.7} // default steps per unit for Ultimaker
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0,280, 50} // X,Y,Z Axis Extend and Retract angles
